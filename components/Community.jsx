        ...
        {[1, 2, 3].map((item) => {
          return (
            <div className="flex group cursor-pointer sm:justify-center items-center">
              <img
                className="rounded-full mr-[1.6rem] sm:mr-2 w-[100px] h-[100px] sm:w-[64px] sm:h-[64px] group-hover:opacity-80"
              ...
              />
              <span className="text-[#2d2d2d] group-hover:bg-[#e3e3e3] sm:text-[18px] sm:leading-[21px] text-[21px] leading-[25px]">
                Watch our video
              </span>
            </div>
          );
