...
export const Spotlight = () => {
  return (
    <div className="mt-[120px] max-w-[84rem] mx-auto sm:px-3">
      <div className="flex justify-between">
        <h1 className={`text-[#2d2d2d]  text-[28px] leading-[33px] mb-[16px]`}>
          Spotlight{" "}
        </h1>
        <button className="text-[#2d2d2d] hover:bg-[#ffcd00] hover:text-[#2d2d2d] hover:border-2 sm:hidden text-center py-[10px] px-[31px] leading-[18px] border border-[#2d2d2d] rounded-full">
